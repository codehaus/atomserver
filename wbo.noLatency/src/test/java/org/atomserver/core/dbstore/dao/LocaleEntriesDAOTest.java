...
public class LocaleEntriesDAOTest extends DAOTestCase {
    ...
    public void testPageWithLocales() throws Exception {
        ...
        */
        ...
        List sortedList = entriesDAO.selectFeedPage(ZERO_DATE, AtomServerConstants.FAR_FUTURE_DATE, 0, -1, pageSize, false,
        ...
        // get page (for "de_DE") 
        sortedList = entriesDAO.selectFeedPage(ZERO_DATE, AtomServerConstants.FAR_FUTURE_DATE, 0, -1, pageSize, false,
