...
public class CategoryPagingEntriesDAOTest extends DAOTestCase {
    ...
    public void testPageWithCategories() throws Exception {
        ...
        */
        ...
        List sortedList = entriesDAO.selectFeedPage(lastMod[1], AtomServerConstants.FAR_FUTURE_DATE, 0, 2,
                                                    null,
        ...
        sortedList = entriesDAO.selectFeedPage(lastMod[1], AtomServerConstants.FAR_FUTURE_DATE, 0, 2,
                                               null,
                                               new BaseFeedDescriptor(workspace, sysId), categoryList);
        log.debug("List= " + sortedList);
        assertEquals( 2, sortedList.size() );
        ...
        sortedList = entriesDAO.selectFeedPage(lastMod[1], AtomServerConstants.FAR_FUTURE_DATE, 0, 3,
                                               null,
                                               new BaseFeedDescriptor(workspace, sysId), categoryList);
        log.debug("List= " + sortedList);
        ...
        */
        ...
        categoryList.add(new BooleanTerm<AtomCategory>("term0", atomCategory));
        sortedList = entriesDAO.selectFeedPage(ZERO_DATE, AtomServerConstants.FAR_FUTURE_DATE, 0, 100,
                                               "zh",
                                               new BaseFeedDescriptor(workspace, sysId), categoryList);
        log.debug("List= " + sortedList);
        assertEquals( 2, sortedList.size() );
    ...
    private void checkSelectEntriesByPagePerCategory( int propIdSeed, String workspace, String sysId, String scheme, String term, int offset ) {
        ...
        List sortedList = entriesDAO.selectFeedPage(ZERO_DATE, AtomServerConstants.FAR_FUTURE_DATE, 0, 100,
                                                    null,
                                                    new BaseFeedDescriptor(workspace, sysId), categoryList);
