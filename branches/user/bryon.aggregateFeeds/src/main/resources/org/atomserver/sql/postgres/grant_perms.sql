grant all privileges on AtomCollection to atomserver;
grant all privileges on AtomWorkspace to atomserver;
grant all privileges on EntryCategory to atomserver;
...
grant all privileges on entrycategorylogevent_entrycategorylogeventid_seq to atomserver;
